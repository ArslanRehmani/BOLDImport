 ...
 * File:		AB_BundleScript_Deploye_FolderID_saveMap.js
 * Date:		01/01/2022
 * 
 ***********************************************************************/
        ...
        afterInstall: function (toversion) {
            ...
            try {
                ...
                var scriptdeploymentSearchObj = search.create({
                    ...
                    filters:
                        [
                            ["title", "is", "AB | SL | Use Save Mapping for CSV Import"]
                        ],
                    columns:
                        [
                ...
                var folderSearchObj = search.create({
                    ...
                    filters:
                        [
                            ["name", "is", "Error File Folder"],
                            "OR",
                            ["name", "is", "Upload CSV Excel formate Folder"],
                            "OR",
                            ["name", "is", "Uploaded CSV Files Folder"]
                        ],
                    columns:
                        [
                            search.createColumn({ name: "internalid", label: "Internal ID" }),
                ...
                if (slInternalIdSEarch && slInternalIdSEarch.length > 0) {
                    ...
                    rec.setValue({
                        fieldId: 'custscript_sl_error_folder',
                        value: folderIDArray[0]
                    });
                    rec.setValue({
                        fieldId: 'custscript_csv_excel_folder_id',
                        value: folderIDArray[1]
                    });
                    rec.setValue({
                        fieldId: 'custscript_csv_data_folderid',
