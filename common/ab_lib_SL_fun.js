...
define(['N/log','N/record','N/file'], function (log,record,file) {
    return {
        ...
        createMapFieldRecords: function (bodyFieldsLineFieldsOBJ,csvFileId,rectypetostring,UpdateRecord,uploadedCSVFileName,csvJSONFileId) {
            ...
            try {
                ...
                mapRecordCreate.setValue(this.fields.fieldId, bodyFieldsLineFieldsOBJ);
